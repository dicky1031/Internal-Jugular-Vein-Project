...
def gen_precition_input(mus_type, muscle_type):
    ...
    prediction_input_test['mua_rank'] = []
    ...
    prediction_input_train['mua_rank'] = []
    ...
    for blc in bloodConc:
        for used_ijv_SO2 in test_SO2:
            ...
            prediction_input_test['id'] += [count]*10
            prediction_input_test['mua_rank'] += [i for i in range(10)]
            ...
            prediction_input_train['id'] += [count]*10
            prediction_input_train['mua_rank'] += [i for i in range(10)]
