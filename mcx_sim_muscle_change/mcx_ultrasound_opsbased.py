...
class MCX:
    ...
    def setDomainMedia(self):
        ...
        # 10: muscle10%
        self.mcxInput["Domain"]["Media"][10]["n"] = self.modelParameters["OptParam"]["Muscle10%"]["n"]
        self.mcxInput["Domain"]["Media"][10]["g"] = self.modelParameters["OptParam"]["Muscle10%"]["g"]
        self.mcxInput["Domain"]["Media"][10]["mua"] = 0
        self.mcxInput["Domain"]["Media"][10]["mus"] = self.modelParameters["OptParam"]["Muscle10%"]["mus"]
        # 11: muscle5%
        self.mcxInput["Domain"]["Media"][11]["n"] = self.modelParameters["OptParam"]["Muscle5%"]["n"]
        self.mcxInput["Domain"]["Media"][11]["g"] = self.modelParameters["OptParam"]["Muscle5%"]["g"]
        self.mcxInput["Domain"]["Media"][11]["mua"] = 0
        self.mcxInput["Domain"]["Media"][11]["mus"] = self.modelParameters["OptParam"]["Muscle5%"]["mus"]
        # 12: muscle3%
        self.mcxInput["Domain"]["Media"][12]["n"] = self.modelParameters["OptParam"]["Muscle3%"]["n"]
        self.mcxInput["Domain"]["Media"][12]["g"] = self.modelParameters["OptParam"]["Muscle3%"]["g"]
        self.mcxInput["Domain"]["Media"][12]["mua"] = 0
        self.mcxInput["Domain"]["Media"][12]["mus"] = self.modelParameters["OptParam"]["Muscle3%"]["mus"]
        # 13: muscle1%
        self.mcxInput["Domain"]["Media"][13]["n"] = self.modelParameters["OptParam"]["Muscle1%"]["n"]
        self.mcxInput["Domain"]["Media"][13]["g"] = self.modelParameters["OptParam"]["Muscle1%"]["g"]
        self.mcxInput["Domain"]["Media"][13]["mua"] = 0
        self.mcxInput["Domain"]["Media"][13]["mus"] = self.modelParameters["OptParam"]["Muscle1%"]["mus"]
