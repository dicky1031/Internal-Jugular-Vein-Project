...
if __name__ == "__main__":
    ...
    for ijv_type in ijv_types:
        for mus_type in mus_types:
            ...
            datasetpath = f"{subject}_dataset_{ijv_size}_muscle_uniform"
            ...
            for mus_run_idx in tqdm(range(mus_start, mus_end+1)):
                ...
                used_SO2 = used_SO2.T
                dataset_output[:, :12] = np.concatenate([used_mus, used_mua, bloodConc, used_SO2], axis=1)
